    ...
    <>
      <div className="w-[80rem] h-[117.5rem] grid grid-cols-1 justify-items-center ">
        <div className="w-[61.26rem] h-[101.19rem]">
          <div className="mt-10 w-[61.25rem] h-[40.13rem] shadow-sm ">
            <GrowthSummary />
            <GardenCarousel />
          </div>
          ...
          <NicknameButton>
            <div className="flex items-center justify-start mt-3 pl-3 p-2 bg-white rounded-[10px] shadow-md w-[61.25rem] h-[7rem]">
              <button onClick={handleToggleNicknameModal}>닉네임 변경</button>
              {isNicknameModalOpen && <NicknameModal />}
            </div>
          </NicknameButton>
          <AccountBarButton>
            <div className="flex items-center justify-between mt-3 pl-3 p-2 bg-white rounded-[10px] shadow-md w-[61.25rem] h-[7rem]">
          ...
          <WithdrawalButton>
            <div className="flex items-center justify-start my-3 pl-3 p-2 bg-white rounded-[10px] shadow-md w-[61.25rem] h-[7rem]">
