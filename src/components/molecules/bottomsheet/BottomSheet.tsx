    ...
    >
      ...
      <div className="relative flex justify-center">
        ...
        >
          ...
          >
            <div className="sm:text-[1.2rem] text-[1.5rem] sm:h-[1.4rem] h-[1.8rem] font-[700] flex flex-row justify-end items-center text-[#6D8B33] ">
              <FaPlus />
              <div className="sm:h-[1.4rem] h-[1.8rem] tracking-tight">추가</div>
            </div>
          </div>
        </div>
        <button
